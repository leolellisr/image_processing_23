...
img_dir = "Ex06_imagens/Brain_Tumor_Dataset/test/test"

# Set the path to the gabarito.txt file
gabarito_file = "gabarito.txt"
...
# Rename the image files and update the gabarito.txt file
